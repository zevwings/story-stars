...
6. 读取正式大纲或作者已经指定的 A 场、B 场或黑暗场；公共规则和下游 skill 不重新判定
...
本页是公共层唯一的场型定性委托入口：正向场 / 黑暗场的最终定性只服从 `$PROJECT_BIBLE`、项目题材页与当场正式事实。其余公共规则、参考页与 skill 只处理已经完成定性的施工流程，不得另立判据，也不得根据机制名称、尺度强弱、身份落差、题材标签或单项风险自行改判。
...
- 项目判定为黑暗场: [黑暗HD流程](./黑暗HD流程.md)、[B场黑暗HD微观感官与双声部规则](./B场黑暗HD微观感官与双声部规则.md)
- A 场设计卡: 按[亲密设计规划协议](./亲密设计规划协议.md)与[项目内模板](./templates/intimacy.md)承接大纲指定场型；B 场 / 黑暗场的执行编排另见对应 planner
